...
6 GOTO 3
10 GOTO 90
90 REM Character setup
91 PLAYNO=9
95 MMC=80:HPC=228:DBC=50:SHC=0:OB1C=65:OBT1C=91:OB2C=65:OBT2C=91
96 FORM=1
100 REM Character setup
103 DIM T(6)
104 CHARACNO=PLAYNO
...
131 RESTORE 9900
132 FOR Z=1 TO PLAYNO
133 READ D$: NAM$(Z)=D$
134 NEXT Z:DIM HLEFT(PLAYNO)
135 FOR Z=1 TO PLAYNO
136 READ D: LVL (Z)=D
137 NEXT Z
138 FOR Z=1 TO PLAYNO
139 READ D: AT (Z)=D:NEXT Z
140 FOR Z=1 TO PLAYNO
141 READ D:DB(Z) = D
142 NEXT Z
143 FOR Z=1 TO PLAYNO
144 READ D: HITS (Z) = D
145 NEXT Z
146 FOR Z=1 TO PLAYNO
147 READ D: SH(Z) = D
148 NEXT Z
149 DIM CRITICAL (2,8)
150 DIM CRIT$(2)
151 DIM KILLED(25)
155 FOR Z=1 TO PLAYNO
156 READ D: OB1(Z) = D
157 NEXT Z
160 FOR Z =1 TO PLAYNO
161 READ D:OBT1(Z) =D
162 NEXT Z
165 FOR Z=1 TO PLAYNO
166 READ D:OB2(Z) =D
167 NEXT Z
170 FOR Z=1 TO PLAYNO
171 READ D: OBT2(Z) =D
172 NEXT Z
175 FOR Z=1 TO PLAYNO
176 READ D: MM(Z) =D
177 NEXT Z
180 FOR Z=1 TO PLAYNO
181 HLEFT(Z)=HITS(Z)
182 NEXT Z
183 FOR Z=1 TO PLAYNO:SIZE(Z)=1:NEXT Z
184 FOR Z=1 TO PLAYNO:READ D:TOTEXP(Z)=D:NEXT Z
185 FOR Z=1 TO PLAYNO
186 READ D: INITB(Z) = D
187 NEXT Z
190 CHARAC=PLAYNO+1
200 LASTSAVED = 0
...
9900 DATA "Anwarewen","Capernicus","Dolwin","Ingwe","Morn","Gularan","Ama'un","Vergorion","Beornas"
9904 REM Level
9905 DATA 13,13,19,13,14,15,13,15,14
9909 REM Armour type
9910 DATA 5,1,1,1,20,1,1,20,1
9914 REM DB
9915 DATA 55,55,70,65,70,50,20,70,85
9919 REM Hits
9920 DATA 68,106,172,77,210,58,70,190,151
9924 REM Shield bonus
9925 DATA 15,0,35,45,40,25,0,45,25
9934 REM Primary OB
9935 DATA 65,131,175,35,142,25,129,140,116
9939 REM Primary weapon type
9940 DATA 57,58,13,16,41,27,27,13,33
9944 REM Secondary OB
9945 DATA 60,76,146,20,77,40,87,95,154
9949 REM Secondary weapon type
9950 DATA 76,72,70,16,72,76,16,76,70
9954 REM M&M bonus
9955 DATA 20,40,35,20,5,45,5,20,5,20
9959 REM Experience points
9960 DATA 265008,262794,474811,261843,287208,323948,260589,332193,315545
9964 REM Initiative bonuses
9965 DATA 0,0,0,0,0,6,0,0,0
9971 REM XP updated after Aug 2018 session by AFC
9972 REM Beornas next level 16, XP 340000.  Level 15 XP gained, level after next session
9973 REM Dolwin next level 20, XP 500000.
9974 REM Gularan next level 16, XP 340000.  Still to update skills for level 15
9975 REM Vergorion next level 16, XP 340000
9976 REM Capernicus next level 14, XP 270000.
9977 REM Morn next level 15, XP 300000.
9978 REM Ama'un next level 14, XP 270000.  Level 13 XP gained, level after next session.  Lowest XP, current gap to Dolwin 219035
9980 REM Ingwe next level 14, XP 270000.
